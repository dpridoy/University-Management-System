...
$obj1 = new Teachers();
$data1=$obj1->getTeachers();

$obj2 = new Students();
$data2 = $obj2->getStudent();
...
<head>
	...
	<title>Dashboard - University Course &amp; Result Management System</title>
				...
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
                        <?php if(isset($_SESSION['userid']['image'])):
                            $image = explode("../../",$_SESSION['userid']['image']);
                            ?>
							...
							<div class="media">
                                <a href="#" class="media-left">
                                    <?php if(isset($_SESSION['userid']['image'])):
                                        $image = explode("../../",$_SESSION['userid']['image']);
                                        ?>
                                        <img src="../<?php echo $image[1]; ?>" class="img-circle img-sm" alt="">
                                    <?php else:?>
