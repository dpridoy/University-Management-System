                                                ...
                                                <ul class="icons-list">
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <li><a href="editStudent.php?id=<?php echo $item['id']?>"><i class="icon-pencil"></i>Edit</a></li>
                                                            <li><a href="deleteStudent.php?id=<?php echo $item['id']?>"><i class="icon-trash"></i>Delete</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </td>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-lg-8 col-lg-offset-1">
                                                                <p>Student id: <?php echo $item['stu_id']?></p>
                                                                <p>Student id: <?php echo $item['password']?></p>
                                                                <p>Student Name: <?php echo $item['name']?></p>
                                                                <p>Address: <?php echo $item['address']?></p>
                                                                <p>Email: <?php echo $item['email']?></p>
                                                                <p>Contact No: +088 <?php echo $item['contactno']?></p>
                                                                <p>Department: <?php echo $item['dname']?></p>
                                                                <p>Register Date: <?php echo $item['registerDate']?></p>
                                                            </div>
                                                            <div class="col-lg-3">
