										...
										<td class="text-center">
											<ul class="icons-list">
												<li class="dropdown">
													...
													<ul class="dropdown-menu dropdown-menu-right">
														<li><a href="editCourses.php?id=<?php echo $item['id'];?>"><i class="icon-pencil"></i>Edit</a></li>
														<li><a href="deleteCourses.php?id=<?php echo $item['id'];?>"><i class="icon-trash"></i>Delete</a></li>
													</ul>
												</li>
											</ul>
										</td>
