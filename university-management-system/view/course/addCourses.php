...
<head>
	...
	<title>Courses - University Course &amp; Result Management System</title>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li class="active"><a href="../course/addCourses.php" id="layout2">Add Courses</a></li>
                                        <li class="active"><a href="../course/viewCoureses.php" id="layout3">View All Courses</a></li>
                                    </ul>
                                </li>
                                <li>
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Course</h4>
						</div>
					</div>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Add Coures</h5>
						...
						<div class="panel-body">
							...
							<form class="form-horizontal form-validate-jquery" action="store.php" method="post">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="code" class="form-control"  placeholder="Enter course code">
                                                ...
                                                <span class="text-danger"><?php echo $_SESSION['code']; unset($_SESSION['code']);?></span>

                                                <?php }elseif(isset($_SESSION['codemsg'])){?>

                                                <span class="text-danger"><?php echo $_SESSION['codemsg']; unset($_SESSION['codemsg']);?></span>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
                                            ...
                                            <?php if (isset($_SESSION['cname'])):?>
                                                <span class="text-danger"><?php echo $_SESSION['cname']; unset($_SESSION['cname']);?></span>
                                            <?php endif; ?>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-2">Credit : <span class="text-danger">*</span></label>
										<div class="col-lg-10">
											<input type="text" name="credit" class="form-control"  placeholder="Enter course credit">
                                            <?php if (isset($_SESSION['credit'])){?>
                                                <span class="text-danger"><?php echo $_SESSION['credit']; unset($_SESSION['credit']);?></span>
                                            <?php }elseif(isset( $_SESSION['creditmsg'])){ ?>
                                                 <span class="text-danger"><?php echo $_SESSION['creditmsg']; unset($_SESSION['creditmsg']);?></span>
                                            <?php } ?>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="control-label col-lg-2"> Semester : <span class="text-danger">*</span></label>
											<div class="col-lg-10">
												<select class="select-search" data-placeholder="Select a semester" name="semester" id="semester" >
                                                    <option></option>
													<optgroup label="All semester">
														<!--<option value="">Select a semester</option>-->
													</optgroup>
												</select>
                                                <?php if (isset($_SESSION['semester'])):?>
                                                    <span class="text-danger"><?php echo $_SESSION['semester']; unset($_SESSION['semester']);?></span>
                                                <?php endif; ?>
											</div>
									</div>
								</fieldset>
