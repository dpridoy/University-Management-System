...
<head>
	...
	<title>Semesters - University Course &amp; Result Management System</title>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										<li class="active"><a href="addSemester.php" id="layout2">Add Semester</a></li>
										<li class="active"><a href="viewSemester.php" id="layout3">View All Semester</a></li>
									</ul>
								</li>
								<li>
				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Semester</h4>
						</div>
					</div>
				...
				<div class="content">
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Add Semesters</h5>
								...
								<fieldset class="content-group">
									...
									<div class="form-group">
										<label class="control-label col-lg-2"> Department : <span class="text-danger">*</span></label>
											<div class="col-lg-10">
												<select class="select-search" data-placeholder="Select a department" required="required" name="department">
                                                    <option></option>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="semester" class="form-control" required="required" placeholder="Enter a semester">
										</div>
									</div>
								</fieldset>
