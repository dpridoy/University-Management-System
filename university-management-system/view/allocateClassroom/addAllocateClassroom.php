                    ...
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li class="active"><a href="../allocateClassroom/addAllocateClassroom.php">Allocate Classroom</a></li>
                                    <li class="active"><a href="../allocateClassroom/viewClassroom.php">View Class Schedule</a></li>
                                </ul>
                            </li>
                            <li>
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Classrooms</h4>
                    </div>
                </div>
                ...
                <div class="breadcrumb-line">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Allocate Classroom</li>
                    </ul>
            ...
            <div class="content">
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Allocate Classroom</h5>
                        ...
                        <form class="form-horizontal form-validate-jquery" action="store.php" method="post">
                            <fieldset class="content-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <select class="select-search" required="required" name="department" id="department">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <select class="select-search" required="required" name="course" id="course">
                                            <optgroup label="Mountain Time Zone">
                                                <option value="">Select a Course</option>
<!--                                                --><?php //if(isset($data2)):
//                                                    foreach($data2 as $item):
//                                                        ?>
<!--                                                        <option value="--><?php //echo $item['course_code'];?><!--">--><?php //echo $item['course_code'];?><!--</option>-->
<!--                                                        --><?php
//                                                    endforeach;
//                                                endif;
//                                                ?>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-2"> Room No : <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                        <select class="select-search" required="required" name="roomno">
                                            <optgroup label="Mountain Time Zone">
                                                <option value="">Select Room No</option>
                                                <?php if(isset($data3)):
                                                    foreach($data3 as $item):
                                                        ?>
                                                        <option value="<?php echo $item['roomno'];?>"><?php echo $item['roomno'];?></option>
                                                        <?php
                                                    endforeach;
                                                endif;
                                                ?>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-2"> Day : <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                        <select class="select-search" required="required" name="day">
                                            <optgroup label="Mountain Time Zone">
                                                <option value="">Select Day</option>
                                                <?php if(isset($data4)):
                                                    foreach($data4 as $item):
                                                        ?>
                                                        <option value="<?php echo $item['day'];?>"><?php echo $item['day'];?></option>
                                                        <?php
                                                    endforeach;
                                                endif;
                                                ?>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-2"> From : <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                        <input type="time" name="from"  class="form-control" id="" placeholder="--:--:--">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-lg-2"> To : <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                        <input type="time" name="to"  class="form-control" id="" placeholder="--:--:--">
                                    </div>
                                </div>
                            </fieldset>
