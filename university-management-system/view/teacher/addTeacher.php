...
$obj2 = new Department();
$data2=$obj2->getDepartmentData();

$obj = new Teachers();
$data=$obj->getDesignation();
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="viewAllTeacher.php">View All Teachers</a></li>
									</ul>
								</li>
                                <li>
							...
							<form class="form-horizontal form-validate-jquery" action="store.php" enctype="multipart/form-data" method="post">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="name" class="form-control" required="required" placeholder="Enter teacher name">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-2">Address: <span class="text-danger">*</span></label>
										<div class="col-lg-10">
											<textarea name="address" rows="5" cols="20" class="form-control" required="required"></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-2">Email : <span class="text-danger">*</span></label>
										<div class="col-lg-10">
											<input type="text" name="email" class="form-control" required="required" placeholder="Enter Email Address">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-2">Contact No : <span class="text-danger">*</span></label>
										<div class="col-lg-10">
											<input type="tel" name="contactno" class="form-control" required="required" placeholder="Enter Contact no">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-2">Designation : <span class="text-danger">*</span></label>
											<div class="col-lg-10">
												<select name="designation" data-placeholder="Select a designation" class="select-search" required="required">
                                                    <option></option>
													<optgroup label="All designation">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="takencredit" class="form-control" required="required" placeholder="Enter a credit">
										</div>
									</div>
                                   <!-- <div class="form-group">
                                        <div class="col-lg-10">
                                            <input type="hidden" name="remainingCredit" class="form-control" required="required" placeholder="Enter a credit">
                                        </div>
                                    </div>-->
									<div class="form-group">
										<label class="control-label col-lg-2">Upload Photo : <span class="text-danger">*</span></label>
										<div class="col-lg-10">
											<img src="../../image/image.jpeg" class="img-responsive img-thumbnail" alt="image" width="120px;" id="img"><br>
							  				<input type="file" name="teacherPhoto" id="file" style="display: none">

							    			<span id="browse_file" class="btn btn-success btn-file" style="width: 120px; font-size: 12px;">Select a Photo</span>
										</div>
									</div>
