                            ...
                            <?php if(isset($data)):
                                ...
                                foreach($data as $item):
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $item['credit_to_be_taken']?></td>
                                        ...
                                        <td class="text-center">
                                            <ul class="icons-list">
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a href="#myModal<?php echo $item['id']?>" data-toggle="modal"><i class="icon-eye"></i>View</a></li>
                                                        <li><a href="editTeacher.php?id=<?php echo $item['id']?>"><i class="icon-pencil"></i>Edit</a></li>
                                                        <li><a href="deleteTeacher.php?id=<?php echo $item['id']?>"><i class="icon-trash"></i>Delete</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </td>
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="myModal<?php echo $item['id']?>" role="dialog" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-lg-8 col-lg-offset-1">
                                                            ...
                                                            <p>Contact No: +088 <?php echo $item['contact']?></p>
                                                            <p>Designation: <?php echo $item['designation']?></p>
                                                            <p>Department: <?php echo $item['dname']?></p>
                                                            <p>Credit to be taken: <?php echo $item['credit_to_be_taken']?></p>
                                                            <p>Remaining Credit: <?php echo $item['remaining_credit']?></p>


                                                        </div>
                                                        <div class="col-lg-3">
                                                            <?php if(isset($item['photo']) && !empty($item['photo'])):?>
                                                                <img src="<?php echo $item['photo']?>" class="img-thumbnail img-responsive" alt="Image" width="150" height="150">
                                                            <?php else:?>
                                                                <img src="../../image/image.jpeg" class="img-thumbnail img-responsive" alt="Image" width="100">
                                                            <?php endif;?>
                                                        </div>
                                                    </div>
                                                </div>
