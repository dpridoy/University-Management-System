            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-8">
                    <div class="panel panel-default">
                        <h5 class="panel-title text-center">Grade Point</h5>
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal form-validate-jquery" action="store.php" method="post">
                            <fieldset class="content-group">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-2"> Select Grade Letter. : <span class="text-danger">*</span></label>
                                    <div class="col-lg-10">
                                        <select class="select-search" data-placeholder="-----Select a grade-----" name="grade" id="grade" required="required">
                                            <option></option>
                                            <optgroup label="All student grade">
                                                <?php if(isset($grade)):
                                                    foreach($grade as $item):
                                                        ?>
                                                        <option value="<?php echo $item['grade'];?>"><?php echo $item['grade'];?></option>
                                                        <?php
                                                    endforeach;
                                                endif;
                                                ?>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#stuid').change(function(){
            var stu_course = $(this).val();
            $.ajax({
                url: "../load.php",
                data: {stu_course: stu_course},
                type: "POST",
                dataType:"text",
                success:function(data){
                    $("#course").html(data);
