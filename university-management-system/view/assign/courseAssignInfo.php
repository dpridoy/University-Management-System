...
$data = $obj->getCoursesInfo();
$t_name = $obj->assignToTeacher();
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Course Assign Information</h5>
		                		...
		                		<form action="#">
									<div class="form-group">
										<div class="col-lg-4 col-lg-offset-4">
											<select class="select-search" required="required">
							...
							<table class="table table-bordered table-hover datatable-highlight">
                                ...
                                ?>
									<tr>
										...
										<td>
                                            <?php if(isset($item["t_id"]) && !empty($item["t_id"])):
                                                if(isset($t_name)):
                                                    echo $t_name["name"];
                                                endif;
                                                else:
                                                    echo "<p class='text-danger'>Not Assigned</p>";
                                                endif;
                                            ?>
                                        </td>
