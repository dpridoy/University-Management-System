...
<head>
    ...
    <title>Enroll In a Course - University Course &amp; Result Management System</title>
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Enroll Student</h4>
                    </div>
                </div>
            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Enroll student In a Course</h5>
                        ...
                        <form class="form-horizontal form-validate-jquery" action="store.php" method="post">
                            <fieldset class="content-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <select class="select-search" data-placeholder="-----Select a course-----" name="course" id="course" required="required">
                                            <option></option>
                                            <optgroup label="All register student">
                                                <?php if(isset($course)):
                                                    foreach($course as $item):
                                                        ?>
                                                        <option value="<?php echo $item['id'];?>"><?php echo $item['cname'];?></option>
                                                        <?php
                                                    endforeach;
                                                endif;
                                                ?>
                            ...
                            <div class="text-right">
                                ...
                                <button type="submit" class="btn btn-primary">Enroll <i class="icon-arrow-right14 position-right"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
